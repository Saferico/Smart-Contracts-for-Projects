...
contract PartyApesClub is ERC721A, Ownable {
   using Strings for uint256;
    ...
    uint256 public constant teamSupply = 21;
    uint256 public constant phaseOneSupply = 1111;
    uint256 public constant phaseTwoSupply = 9889;
    uint256 public teamAmountMinted = 0;
    uint256 public presaleCost = 0.37 ether;
    uint256 public publicSaleCost = 0.46 ether;
    uint256 public collabCost = 0.46 ether;

    uint256 public phaseTwoCollabSupply = 555;
    uint256 public phaseTwoCollabAmountMinted = 0;

    uint256 public maxAmountPerPublicSaleAccount = 3;
    uint256 public maxAmountPerPresaleAccount = 3;
